...
public class Team22PositionalMergeTest {
    ...
    private Table<String, Integer, List<Integer>> createPositional(List<Document> docs){
        ...
        for(Document d: docs){
            ...
            for (int i = 0; i < tokens.size(); i++){
                ...
                table.get(tokens.get(i), docID).add(i); // positional idx start from 1  //todo:test case is wrong, change it from +1 to 0
            }
    ...
    public void thresholdMergeTest(){
        ...
        for (int i = 0; i < documents.length; i++){
            ...
            if (i < documents.length-2) { //todo:test case is wrong, change it from -1 to -2
